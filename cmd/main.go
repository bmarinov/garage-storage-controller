...
func main() {
	...
	// Metrics endpoint is enabled in 'config/e2e/kustomization.yaml'. The Metrics options configure the server.
	// More info:
	...
	// - [METRICS-WITH-CERTS] at config/e2e/kustomization.yaml to generate and use certificates
