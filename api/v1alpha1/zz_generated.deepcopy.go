...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ExistingBucketSpec) DeepCopyInto(out *ExistingBucketSpec) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ExistingBucketSpec.
func (in *ExistingBucketSpec) DeepCopy() *ExistingBucketSpec {
	if in == nil {
		return nil
	}
	out := new(ExistingBucketSpec)
